...
import com.nsw.form.ProductForm;
...
public class SellerProductController {
     ...
     */
    @PostMapping("/save")
//    @CachePut(cacheNames = "product", key = "123")  //当修改内容之后，将修改后的内容更新到redis缓存，但返回值要与查询缓存的保持一致
//    @CacheEvict(cacheNames = "product", key = "123")  //当修改内容之后，将该redis缓存清除
